...
//$params    = &$this->item->params; // This caused "Attempt to modify property "params" on null" error with PHP8.0 /2023-01-09 thoni56
// Also replaced the only use if this "shortcut" on line after "if ($article->params->get('access-edit'))"
$n         = count($this->items);
    ...
    <table class="category table table-striped table-bordered table-hover<?php echo $tableClass; ?>">
        ...
        <thead>
            <tr>
                ...
                <?php if ($article->catid == 59) : ?>
                    <th scope="col" id="category_list_header_speaker">
                      Talare
                    </th>
                <?php endif; ?>
        ...
        <?php foreach ($this->items as $i => $article) : ?>
            ...
            <?php if ($article->catid == 59) : ?>
                <!-- Code for categories that have fields to display -->
                <!-- this code to grab the fields by using the fieldshelper -->
            ...
            <td headers="categorylist_header_title" class="list-title">
                ...
                <?php endif; ?>
                <?php if ($article->publish_up && strtotime($article->publish_up) > strtotime(JFactory::getDate())) : ?>
                    <span class="list-published label label-warning">
                                <?php echo JText::_('JNOTPUBLISHEDYET'); ?>
                            </span>
                <?php endif; ?>
                <?php if ($article->publish_down && (strtotime($article->publish_down) < strtotime(JFactory::getDate())) && $article->publish_down != JFactory::getDbo()->getNullDate()) : ?>
                    <span class="list-published label label-warning">
            ...
            <!-- Display some fields for some categories: Presentationer på DevLin2018 -->
            <?php if ($article->catid == 59) : ?>
                <td><?php echo $article->jcFields['talare']->value; ?></td>
            <?php endif; ?>

            <!-- Display some fields for some categories: Talare på DevLin2018 -->
            <?php if ($article->catid == 60) : ?>
                <td><?php echo $article->jcFields['presentationer']->value; ?></td>
            <?php endif; ?>
            ...
            <?php if ($isEditable) : ?>
                <td headers="categorylist_header_edit" class="list-edit">
                    <?php if ($article->params->get('access-edit')) : ?>
                        <?php echo JHtml::_('icon.edit', $article, $this->item->params); ?>
                    <?php endif; ?>
                </td>
            <?php endif; ?>
            </tr>
