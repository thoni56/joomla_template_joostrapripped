...
$doc->addScript($tplUrl . '/js/isotope.pkgd.min.js');
$doc->addScript($tplUrl . '/js/isotope-layout.js');
?>
<div class="joostrap-portfolio <?php echo $this->pageclass_sfx;?>">
<div class="headline">
	<h4><?php echo $this->escape($this->params->get('page_heading')); ?></h4>
</div>
	<?php if (!empty($this->children[$this->category->id])&& $this->maxLevel != 0) : ?>
	<div class="portfolio-nav">
		<div class="joostrap btn-group pull-right">
			...
			<ul id="filters" class="option-set clearfix dropdown-menu" data-option-key="filter">
				<li class="btn btn-primary"><a href="#" data-option-value="*" class="selected"><?php echo $this->escape($this->params->get('all_text')); ?></a></li>
