	...
	$(document).ready(function () {
		...
		$('.jmoddiv').on({
			mouseenter: function() {
				...
				$(this).addClass('jmodinside')
					.prepend('<a class="btn jmodedit" href="#" target="_blank"><span class="fa fa-pencil-square-o"></span></a>')
					.children(":first").attr('href', moduleEditUrl).attr('title', moduleTip)
					.tooltip({"container": false, placement: tooltipPlacer, html: true})
		...
		$('.jmoddiv[data-jmenuedittip] .nav li,.jmoddiv[data-jmenuedittip].nav li,.jmoddiv[data-jmenuedittip] .nav .nav-child li,.jmoddiv[data-jmenuedittip].nav .nav-child li').on({
			mouseenter: function() {
				...
				var content = $('<div><a class="btn jfedit-menu" href="#" target="_blank"><span class="fa fa-pencil-square-o"></span></a></div>');
